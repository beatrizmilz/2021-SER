...
<a href='https://livro.curso-r.com/'>  <img src='https://curso-r.github.io/my-first-dashboard-with-shiny-csds2019/img/cursor.png' width="200px"></a>
...
- Introduzir o conceito de GitHub Actions:
  ...
  - Quais são os pré-requisitos para usar GHA?
  
  - Onde buscar mais informações sobre GHA
