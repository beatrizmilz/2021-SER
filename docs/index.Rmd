...
(caso queira executar os testes, e fazer a avaliação da cobertura dos mesmos)
...
- Os arquivos .yaml que armazenam informações os fluxos de trabalho, onde estão descritos os eventos e trabalhos:
  ...
  - Trabalho: Um evento aciona o fluxo de trabalho (workflow), que contém um trabalho. 
